...
public class StatBar extends DisplayBars
{
    ...
    { 
        ...
        fg.drawImage(new GreenfootImage("" + myWorld.getScoutOnScreen(), 18, Color.WHITE, transparent), 175, 37);
        fg.drawImage(new GreenfootImage("" + myWorld.getSoldierOnScreen(), 18, Color.WHITE, transparent), 175, 57);
        fg.drawImage(new GreenfootImage("" + myWorld.getZombieOnScreen(), 18, Color.WHITE, transparent), 175, 77);
        fg.drawImage(new GreenfootImage("" + myWorld.getHumanKilledCount(), 18, Color.WHITE, transparent), 360, 37);
        fg.drawImage(new GreenfootImage("" + myWorld.getZombieKilledCount(), 18, Color.WHITE, transparent), 360, 57);
        fg.drawImage(new GreenfootImage("" + myWorld.getHumanConvertedCount(), 18, Color.WHITE, transparent), 360, 77);
        fg.drawImage(new GreenfootImage("" + myWorld.getTotalSupply(), 18, Color.WHITE, transparent), 260, 111);
        fg.drawImage(new GreenfootImage("" + myWorld.getTotalZombieSpawn(), 18, Color.WHITE, transparent), 260, 131);
