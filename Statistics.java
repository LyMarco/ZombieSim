...
public class Statistics extends DisplayBars
{
    ...
    private Color transparent; // transparent backgrounds for the text displays
    ...
    public Statistics (int population, int food, int weapons) {     
        ...
        textFont = new Font("Courrier", true, false, 20);
        populationValue = new GreenfootImage("=   " + population, 20, textColorPop, transparent);
        foodValue = new GreenfootImage("=   " + food, 20, textColorFood, transparent);
        weaponsValue = new GreenfootImage("=   " + weapons, 20, textColorWeap, transparent);
